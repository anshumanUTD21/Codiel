      ...
      User.findOne(
        ...
        function (err, user) {
          ...
          if (!user || user.password != password) {
            ...
            //here done take two argument, null means no eror and false means authentication has not been done
...
//serialized user function unserialized user function

//serializing the user to decide whihch key is to be kept in the cookies
